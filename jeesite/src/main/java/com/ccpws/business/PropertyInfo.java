...
public class PropertyInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the propertyName value for this PropertyInfo.
     * 
     * @return propertyName
     */
    ...
    /**
     * Sets the propertyName value for this PropertyInfo.
     * 
     * @param propertyName
     */
    ...
    /**
     * Gets the propertyValue value for this PropertyInfo.
     * 
    ...
    /**
     * Sets the propertyValue value for this PropertyInfo.
     * 
     * @param propertyValue
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://business.ccpws.com/", "propertyInfo"));
